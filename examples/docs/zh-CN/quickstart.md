...
```javascript
import Vue from 'vue';
import ElementUI from 'zrwsdele-ui';
import 'zrwsdele-ui/lib/theme-chalk/index.css';
...
```javascript
import Vue from 'vue';
import { Button, Select } from 'zrwsdele-ui';
import App from './App.vue';
...
```js
import Vue from 'vue';
import { Button } from 'zrwsdele-ui';
